...
const DoctorAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const cityName = City.getAllCities().find(city => city.name === formData.city)?.name;
    const countryName = Country.getAllCountries().find(country => country.isoCode === formData.country)?.name;
    const stateName = State.getAllStates().find(state => state.isoCode === formData.state)?.name;
    console.log(cityName, countryName, stateName)
    ...
    dataToSubmit.set("countryCode", isoCodes);
