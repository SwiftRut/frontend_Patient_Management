      ...
      <div className="container mx-auto p-4">
        <div className="bg-white shadow-lg w-full h-auto p-4 rounded-xl">
          <div className="flex flex-col md:flex-row justify-between items-center mb-3">
            <h1 className="text-[26px] font-bold mb-2 md:mb-0">Medical History</h1>
          </div>
              ...
              {medicalhistory.map((val, index) => (
                ...
                >
                  <div className="flex justify-between items-center py-2 bg-gray-100 px-3">
                    <h6 className="text-[18] text-[#030229] font-semibold">{val.doctorName}</h6>
                  ...
                  <div className="flex justify-between items-center pt-3 px-3">
                    ...
                    <span className="text-[#4F4F4F] text-[16px] font-normal">{val.date}</span>
                  </div>
                  <div className="px-3 pb-3">
                    <p className="text-[#4F4F4F] text-[16px] font-bold">Patient Issue</p>
                    <span className="text-[#4F4F4F] text-[16px] font-normal">{val.patientIssue}</span>
                  </div>
                </div>
              ))}
            </div>
